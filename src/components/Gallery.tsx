...
const photos = [
  ...
  { src: "/photos/cutouts/marechiara.webp", alt: "Marechiara — fish fillet in seafood sauce ringed with clams and mussels over linguine", caption: "Marechiara", sub: "Seafood Special", w: "w-[82vw] md:w-[40vw]" },
